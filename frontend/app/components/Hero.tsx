      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-20">
        <div className="text-center mb-12">
          <motion.h1
            ...
            className="text-4xl md:text-6xl lg:text-7xl text-white mb-6 font-light tracking-wide"
          >
            Experience
            <br />
            <span className="font-normal">Timeless Luxury</span>
          </motion.h1>
          ...
          >
            Discover a sanctuary where exceptional service meets understated elegance,
